        ...
        for (const eachBttn of bttn) {
            eachBttn.addEventListener('click', function(){
                ...
                if (index == 1){
                    ...
                    typed = new Typed('#element', {
                        strings: ['since i was a kid', 'every choice i made was with my future in mind', 'my future always resembled what my life would be like in my 20s', 'i am turning 22 this year'],
                        typeSpeed: 50,
                        showCursor: false,
                      });
                }
